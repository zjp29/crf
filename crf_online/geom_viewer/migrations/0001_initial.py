# Generated by Django 3.0.3 on 2020-05-04 07:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trinh', models.CharField(blank=True, max_length=255, null=True)),
                ('resourcename', models.CharField(blank=True, max_length=255, null=True)),
                ('restype', models.CharField(blank=True, max_length=255, null=True)),
                ('resourcecollections', models.CharField(blank=True, max_length=255, null=True)),
                ('accessionno', models.CharField(blank=True, max_length=255, null=True)),
                ('collectionsfacility', models.CharField(blank=True, max_length=200, null=True)),
                ('age', models.CharField(blank=True, max_length=255, null=True)),
                ('info', models.CharField(blank=True, max_length=255, null=True)),
                ('resourcenotes', models.CharField(blank=True, max_length=1000, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportnum', models.CharField(db_column='ReportNum', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnumber', models.CharField(blank=True, db_column='PNumber', max_length=11, null=True, unique=True)),
                ('status', models.CharField(blank=True, db_column='Status', max_length=255, null=True)),
                ...
                ('pdf', models.BooleanField(blank=True, db_column='pdf', null=True)),
                ('shp', models.BooleanField(blank=True, db_column='shp', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnumber', models.ForeignKey(blank=True, db_column='PNumber', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.tblResource', to_field='pnumber')),
            ],
            options={
                'db_table': 'tblResX',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportnum', models.ForeignKey(blank=True, db_column='ReportNum', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.tblInventory', to_field='reportnum')),
            ],
            options={
                'db_table': 'tblInvX',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.ForeignKey(blank=True, db_column='Label', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.tblResource', to_field='pnumber')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docsource', models.CharField(blank=True, db_column='DocSource', max_length=25, null=True)),
                ('digsource', models.CharField(blank=True, db_column='DigSource', max_length=25, null=True)),
                ('reportnum', models.CharField(blank=True, db_column='ReportNum', max_length=9, null=True)),
                ('notes', models.CharField(blank=True, db_column='Notes', max_length=255, null=True)),
                ('hyperlink', models.CharField(blank=True, db_column='Hyperlink', max_length=250, null=True)),
                ('shape_length', models.FloatField(blank=True, db_column='SHAPE_Length', null=True)),
                ('shape_area', models.FloatField(blank=True, db_column='SHAPE_Area', null=True)),
                ('digorg', models.CharField(blank=True, db_column='DigOrg', max_length=255, null=True)),
                ('confidential', models.CharField(blank=True, db_column='Confidential', max_length=3, null=True)),
                ('label', models.ForeignKey(blank=True, db_column='Label', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.tblInventory', to_field='reportnum')),
            ],
            options={
