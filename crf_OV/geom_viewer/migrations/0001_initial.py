# Generated by Django 3.0.3 on 2020-05-03 00:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnumber', models.ForeignKey(blank=True, db_column='PNumber', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.NwicCcdCrf')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reltype', models.CharField(blank=True, db_column='RelType', max_length=255, null=True)),
                ('reportnum', models.ForeignKey(blank=True, db_column='ReportNum', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.Tblinventory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.ForeignKey(blank=True, db_column='Label', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='geom_viewer.NwicCcdCrf')),
            ],
            options={
